...
class GazeboEnv:
    ...
    def step(self, actions):
        ...
        for i in range(len(self.car_names)):
            ...
            reward = self.get_reward(self.target_reached[i], collision, action, distance, theta)
    ...
    def get_reward(self, target, collision, action, distance, theta):
        # 基本奖励计算
        ...
        # 计算航向角奖励
        heading_reward = (1 - abs(theta) / np.pi) * 2 - 1
