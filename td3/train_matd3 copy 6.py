...
class TD3(object):
    ...
    def load(self, filename, directory):
        try:
            ...
            self.actor.load_state_dict(old_actor_dict, strict=True)  # 使用 strict=True 严格匹配
            self.critic.load_state_dict(old_critic_dict, strict=True)
            print("Loaded pre-trained model successfully with strict matching.")
