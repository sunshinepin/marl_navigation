...
class GazeboEnv1:
    def __init__(self, launchfile, environment_dim):
        ...
        self.publisher = rospy.Publisher("car1/goal_point", MarkerArray, queue_size=3)
        self.publisher2 = rospy.Publisher("car1/linear_velocity", MarkerArray, queue_size=1)
        self.publisher3 = rospy.Publisher("car1/angular_velocity", MarkerArray, queue_size=1)
        ...
        self.trajectory_file = "../trajectory_car1.txt"
        self.clear_trajectory_file()
        self.trajectory_pub = rospy.Publisher("car1/trajectory", Marker, queue_size=10)
    ...
    def change_goal(self):
        ...
        # 打印改变后的目标点位置
        print(f"car1改变后的目标点位置: x={self.goal_x}, y={self.goal_y}")
