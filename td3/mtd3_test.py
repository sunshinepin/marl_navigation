...
max_ep = 1000
file_names = [
    "TD3_velodyne_actor_car1.pth",
    "TD3_velodyne_actor_car2.pth",
    "TD3_velodyne_actor_car3.pth"
]

state_dim = 24
action_dim = 2
num_tests = 10  # 根据文件中测试用例数量调整
save_dir = "/home/xzh/xzh/madrl-navigation/data_processing/mtd3_test/world1"
