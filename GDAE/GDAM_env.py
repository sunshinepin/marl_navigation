...
class ImplementEnv:
    def __init__(self, args):
        ...
        self.vel_pub_rob = rospy.Publisher('/car1/cmd_vel', Twist, queue_size=1)
        ...
        self.navLaserTop = rospy.Subscriber('/car1/scan', LaserScan, self.Laser_callback_Top, queue_size=1)
